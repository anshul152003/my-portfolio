...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+91) 7240922563",
    action: () => (window.location.href = "tel:++91-7240922563"),
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "anshulgangrade.15@gmail.com",
    action: () => (window.location.href = "mailto:anshulgangrade.15@gmail.com"),
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Location",
    ...
    action: () =>
      window.open("https://shorturl.at/ourKS", "_blank"),
  },
];
...
const Contact = () => {
  ...
  async function handleSubmit(event) {
    ...
    formData.append("access_key", "19b4b9c1-0f17-46c7-b9a8-327bca54f8b9");
